...
> If you have any ideas you want to see added in this pack, you can make a pull request explaining what you want to add (on the github page of the mod)
>
...
***
\
![banner](https://github.com/Raphoulfifou/Smooth-GUI/blob/main/images/dark_banner.png?raw=true)
![example_image](https://github.com/Raphoulfifou/MC-Resource-Packs/blob/main/CTM_OF_Fabric/images/all_ctm.png?raw=true)
